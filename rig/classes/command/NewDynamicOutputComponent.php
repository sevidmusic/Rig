...
class NewDynamicOutputComponent extends AbstractCommand implements Command
{
    ...
    {
        $templatePath = str_replace('rig' . DIRECTORY_SEPARATOR . 'classes' . DIRECTORY_SEPARATOR . 'command', 'FileTemplates', __DIR__) . DIRECTORY_SEPARATOR . 'DynamicOutputComponent.php';
    ...
    {
        return $flags['path-to-apps-directory'][0] . DIRECTORY_SEPARATOR . $flags['for-app'][0] . DIRECTORY_SEPARATOR . 'DynamicOutput';
    }
    ...
    {
        return str_replace(['Apps', 'tmp'], 'SharedDynamicOutput', $flags['path-to-apps-directory'][0]);
    }
    /**
    ...
    private function validateArguments(array $preparedArguments): array
    {
        ...
        if(isset($flags['initial-output'][0]) && isset($flags['initial-output-file'][0])) {
            throw new RuntimeException('  The --initial-output and --initial-output-file flags cannot be used together.  For help use rig --help --new-dynamic-output-file');
        }
